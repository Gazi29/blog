...
?>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="http://localhost/abc/index/index.php" class="logo mr-auto"><img src="assets/img/oerlogo.png" alt="" class="img-fluid" style="zoom:1.9"></a>

      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <!--<li class="nav-home"><a href="index.php?page=home">Home</a></li>-->
          <li class="nav-home"><a href="http://localhost/abc/index/index.php">Home</a></li>
          <li class="drop-down"><a href="javascript:void(0)">Blog</a>
            <ul>
              <?php
          ...
          <!--<li class="nav-about"><a href="index.php?page=about">Our Team</a></li>-->
        </ul>
      </nav><!-- .nav-menu -->
